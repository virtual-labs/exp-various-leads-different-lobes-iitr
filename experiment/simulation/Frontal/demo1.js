...
document.getElementById("check-button").addEventListener("click", function () {
 ...
 var correct_connections_5_14 = [
        ...
        var is_connected_4_13 = false;
         var is_connected_5_14 = false;
        ...
        actual_connections.forEach(function (connection) {
            ...
            if(!is_connected_4_13){
                is_connected_4_13 = correct_connections_4_13 .find(function (conn) {
                    return conn.source === this_connection.source && conn.target === this_connection.target;
                  });
            }
           if(!unallowed_connection_present){
       ...
       actual_connections.forEach(function (connection) {
            ...
            if(!is_connected_5_14){
                is_connected_5_14 = correct_connections_5_14 .find(function (conn) {
                    return conn.source === this_connection.source && conn.target === this_connection.target;
                  });
            }
           if(!unallowed_connection_present){
...
if ( is_connected_1_10&&is_connected_2_11&&is_connected_3_12&&is_connected_4_13&&is_connected_5_14&&is_connected_6_8&&is_connected_7_9&& !unallowed_connection_present) {
